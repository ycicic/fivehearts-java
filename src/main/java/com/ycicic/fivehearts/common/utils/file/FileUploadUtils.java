...
import com.ycicic.fivehearts.common.exception.file.FileNameLengthLimitExceededException;
import com.ycicic.fivehearts.common.exception.file.FileSizeLimitExceededException;
import com.ycicic.fivehearts.common.exception.file.InvalidExtensionException;
import com.ycicic.fivehearts.common.utils.DateUtils;
import com.ycicic.fivehearts.common.utils.StringUtils;
import com.ycicic.fivehearts.common.utils.uuid.Seq;
import com.ycicic.fivehearts.framework.config.FiveHeartsConfig;
import com.ycicic.fivehearts.framework.config.MinioConfig;
...
public class FileUploadUtils {
     ...
     * 本地默认上传的地址
     */
    private static String defaultBaseDir = FiveHeartsConfig.getProfile();
    ...
    public static String getPathFileName(String uploadDir, String fileName) {
        int dirLastIndex = FiveHeartsConfig.getProfile().length() + 1;
