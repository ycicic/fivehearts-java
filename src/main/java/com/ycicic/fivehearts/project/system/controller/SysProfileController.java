...
import com.ycicic.fivehearts.framework.security.service.TokenService;
...
import com.ycicic.fivehearts.common.utils.file.FileUploadUtils;
import com.ycicic.fivehearts.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(FiveHeartsConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
